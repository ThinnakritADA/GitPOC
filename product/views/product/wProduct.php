...
<?php if (isset($nPdtBrowseType) && $nPdtBrowseType == 0): //เข้ามาจาก Menu Product ทางซ้ายมือ?>
			...
			<div class="row xCNavRow" style="width:inherit;">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<ol id="oliMenuNav" class="breadcrumb xCNBCMenu xWProductBreadcrumb">
						...
						<li id="oliPdtTitleAdd" class="active">
							<a>
								<?php echo language('product/product/product', 'tPDTTitleAdd') ?>
							</a>
						</li>
						<li id="oliPdtTitleEdit" class="active">
							<a>
								<?php echo language('product/product/product', 'tPDTTitleEdit') ?>
							</a>
						</li>
					</ol>
				</div>
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 text-right p-r-0">
					...
					<div id="odvBtnPdtAddEdit">
						<button id="obtCallBackProductList" class="btn xCNBTNDefult xCNBTNDefult2Btn" type="button">
							<?php echo language('common/main/main', 'tBack') ?>
						</button>
		...
		<div class="modal-header xCNModalHead">
			<div class="row">
				<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
					<a onclick="JCNxBrowseData('<?php echo $tPdtBrowseOption ?>')" class="xWBtnPrevious xCNIconBack"
						style="float:left;">
						<i class="fa fa-arrow-left xCNIcon"></i>
					</a>
					<ol id="oliPvnNavBrowse" class="breadcrumb xCNMenuModalBrowse">
						<li class="xWBtnPrevious" onclick="JCNxBrowseData('<?php echo $tPdtBrowseOption ?>')"><a>
								<?php echo language('common/main/main', 'tShowData'); ?> :
								<?php echo language('payment/card/card', 'tCRDTitle') ?>
							</a></li>
						<li class="active"><a>
								<?php echo language('product/product/product', 'tPDTTitleAdd') ?>
							</a></li>
				...
				<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
					<div id="odvPvnBtnGroup" class="demo-button xCNBtngroup" style="width:100%;">
						<button type="button" class="btn xCNBTNPrimery" onclick="$('#obtAddEditProduct').click()">
							<?php echo language('common/main/main', 'tSave') ?>
						</button>
					</div>
				</div>
	...
	<div class="modal fade" id="odvModalWanningProductBarDup" tabindex="-1" role="dialog"
		style="overflow: hidden auto; z-index: 5000; display: none;">
		<div class="modal-dialog" id="modal-customsWanning" role="document" style="margin: 1.75rem auto;top:20%;">
			<div class="modal-content" id="odvModalBodyWanningProductBarDup">
				<div class="modal-header xCNModalHead">
					<h3 style="font-size:20px;color:#FFFF00;font-weight: 1000;"><i class="fa fa-exclamation-triangle"></i>
						<?php echo language('common/main/main', 'tModalWarning'); ?>
					</h3>
				</div>
				<div class="modal-body">
					<?php echo language('common/main/main', 'tPdtEventAddProductValidateAgency'); ?>
				</div>
	...
	<div class="modal fade" id="odvModalWanningProductBarDupImport" tabindex="-1" role="dialog"
		style="overflow: hidden auto; z-index: 8000; display: none;">
		<div class="modal-dialog" id="modal-customsWanning" role="document" style="margin: 1.75rem auto;top:20%;">
			<div class="modal-content" id="odvModalBodyWanningProductBarDupImport">
				...
				<div class="modal-body">
					<?php echo language('common/main/main', 'tPdtEventAddProductValidateAgency2'); ?>
				</div>
				<div class="modal-footer">
	...
	<script type="text/javascript"
		src="<?php echo base_url('application/modules/product/assets/src/product/jProduct.js?v=2') ?>"></script>
